...
// exercised for real rather than mocked away. The two credentials live in
// different slots: a pasted admin token is a secret and is stored; a browser
// sign-in is only flagged, because its token stays in the httpOnly cookie.
...
const PASTED_TOKEN = { dst_admin_token: 'dstadm_pasted' }
const SIGNED_IN = { dst_session_active: '1' }
