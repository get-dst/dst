    ...
    <div className="flex h-full flex-col">
      ...
      <main className="flex-1 overflow-auto">
        <Routes>
          ...
          {/* The Statement lives as Observe's landing tab; /audit stays a
              deep link to it. The drift audit is a Certify tab at /certify/drift. */}
          <Route path="/audit" element={<Observe initialTab="audit" />} />
          <Route path="/certify/drift" element={<Certify initialTab="drift" />} />
