...
test('the Context tab is gone — its content lives on Tables, Certified definitions and Files', async () => {
  renderDetail()
  await screen.findByRole('tab', { name: 'Activity' })
  // The merged tree duplicated other tabs and read as a wall; it must not return.
