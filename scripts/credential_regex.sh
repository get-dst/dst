...
# They are documented constants, not secrets, and they appear in the docs and
# the local-development configuration by design. Allowing them EXACTLY (never a prefix match, never a
