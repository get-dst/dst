...
def _definition_applied(
    question: str, semantic_model: SemanticModel, definition_used: str | None, sql: str
) -> VerificationCheck:
...
def _intent_alignment(question: str, sql: str, dialect: str) -> VerificationCheck:
    ...
    return VerificationCheck(
        name="intent_alignment", status="skip", reason="intent not determinable from the question"
    )
...
def build_report(
    *,
    ...
    checks = [
        ...
        _definition_applied(question, semantic_model, definition_used, sql),
