    ...
    def _trace_failure(
        ...
        if status == "rejected":
            ...
            msg = (
                ...
                f"limit of your question or the lens scope ({reason}). Re-asking may "
                "succeed; if it repeats, report it."
            )
        else:
        ...
        return PipelineResult(
            response=QueryResponse(
                lens=lens_name,
                status="rejected" if status == "rejected" else "error",
                answer=msg,
                ...
                sql=None if status == "rejected" else sql,
        ...
        if gate is not None and gate.status == "fail":
            ...
            if final is not None and final.status == "fail":
                ...
                ans.text = (
                    ...
                    "figures not grounded in the result, and was withheld. "
                    f"The result itself:\n{preview}{more}"
                )
