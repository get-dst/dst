...
of rule is what a live embedder run needs (compressed cosines → a single absolute
...
# The shipped thresholds: the offline eval runs against these, and the
# live-embedder behaviour is pinned to them. The exact
