...
from services.api.mgmt_directory import router as mgmt_directory_router
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    """Run the MCP session manager + the audit scheduler for the app's lifetime."""
...
_openapi_tags = [
    ...
    {
        "name": "directory",
        "description": "The org's people plus the derived access groups lens allow-lists use.",
    },
    {
        "name": "standards",
...
app.include_router(mgmt_directory_router)
