...
OpenAI, DeepSeek, Ollama, vLLM, most gateways), `voyage` for embeddings, and
...
credential or session is the backstop. Prose context is bring-your-own: your
agent or scripts push docs into a lens via the `/mgmt/lenses/{name}/context/*`
endpoints. See
